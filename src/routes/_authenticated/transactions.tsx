  ...
  head: () => ({
    meta: [
      { title: "Transactions — StockLine" },
      {
        name: "description",
        content:
          "Review the full audit log of stock-in and stock-out movements across your inventory.",
      },
              ...
              <CardContent className="p-3">
                <div className="grid grid-cols-[minmax(0,1fr)_auto] items-start gap-2">
                  ...
                  <div className="shrink-0 flex flex-col items-end gap-1">
                    ...
                    <div
                      className={`text-sm font-semibold ${t.type === "in" ? "text-success" : "text-warning"}`}
                    >
                      {t.type === "in" ? "+" : "−"}
                      {t.quantity}
                    </div>
                ...
                {t.notes && (
                  <div className="mt-2 text-xs text-muted-foreground border-t pt-2">{t.notes}</div>
                )}
              </CardContent>
            </Card>
          ))
