...
export const Route = createFileRoute("/_authenticated/categories")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Organize your inventory by category to keep products grouped and easy to find.",
      },
  ...
  const save = useMutation({
    mutationFn: async () => {
      ...
      if (editing) {
        ...
        const { error } = await supabase
          .from("categories")
          .insert({ name: name.trim(), description: description || null, org_id: profile.org_id });
        if (error) throw error;
      }
    },
    onSuccess: () => {
